...
$userId = isset($_GET['id']) ? (int)$_GET['id'] : 0; // ID des Blogposts wird aus URL mitgegeben (GET)
...
if (isset($_POST['delete-button'])) {
    try {
        ...
        header("Location: cms_clients.php?deletion_success=true");
        exit();
...
<main class="main-content">
	...
	<section class="create-form">
		...
		<div class="create-form__header">
			<p>Sind Sie sicher, dass Sie den Kunden löschen möchten?</p>
		</div>
