...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	try {
		...
		$query = $db->prepare("INSERT INTO Users (title, first_name, last_name, city, street, postcode, email) VALUES(:title, :first_name, :last_name, :city, :street, :postcode, :email)"); 
	...
	header("location: cms_clients.php?adding_success=true"); 
	...
	<section class="create-form">
		...
		<form class="create-form__body" id="form-03" method="POST" enctype="multipart/form-data" action="#">
			...
			<div class="create-form__lines">
				...
				<div class="create-form__line">
					...
					<select class="create-form__input" id="title-04" name="title" value="" autocomplete="off"
						type="text">
						<option value="1" <?php if (isset($_POST['title']) && $_POST['title']==1) echo 'selected' ; ?>
							>Herr</option>
						<option value="2" <?php if (isset($_POST['title']) && $_POST['title']==2) echo 'selected' ; ?>
							>Frau</option>
						<option value="3" <?php if (isset($_POST['title']) && $_POST['title']==3) echo 'selected' ; ?>
							>Divers</option>
					</select>
				</div>
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="first-name-04" name="first-name"
						value="<?php if (isset($_POST['first-name'])) { echo $firstName; } ?>" autocomplete="off"
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="last-name-04" name="last-name"
						value="<?php if (isset($_POST['last-name'])) { echo $lastName; } ?>" autocomplete="off"
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="city-04" name="city"
						value="<?php if (isset($_POST['city'])) { echo $city; } ?>" autocomplete="off" type="text"
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="street-04" name="street"
						value="<?php if (isset($_POST['street'])) { echo $street; } ?>" autocomplete="off" type="text"
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="postcode-04" name="postcode"
						value="<?php if (isset($_POST['postcode'])) { echo $postcode; } ?>" autocomplete="off"
				...
				<div class="create-form__line">
					...
					<input class="create-form__input" id="email-04" name="email"
						value="<?php if (isset($_POST['email'])) { echo $email; } ?>" autocomplete="off" type="text"
			...
			<div class="button-container">
				<a href="cms_clients.php"><button class="create-form__button cancel-button" type="button"><svg
